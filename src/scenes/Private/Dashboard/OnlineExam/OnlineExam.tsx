...
import edit from '../../../../assets/img/EditBlue.svg';
        ...
        <div className="w-full h-full flex flex-col items-center justify-start pt-[1vw] p-[1vw]">
            {(() => {
                switch (SubPagine) {
                    ...
                    case 1:
                        return (
                            <div className="flex flex-col justify-start h-full w-full p-[1vw] gap-[1.5vw]">
                                <h1 className="underline px-[1vw]">MIS RESULTADOS</h1>
                                <div className="bg-white p-4 rounded-lg shadow-md h-[80%] w-full border-2 border-solid border-[#F3F3F3] gap-[1vw] overflow-auto">
                                ...
                                <div className="w-1/2 flex px-[1vw]">
                                    <button
                                        className="bg-[#00AEEF] text-white font-semibold px-4 py-2 mt-4 rounded-lg border-2 border-transparent hover:bg-[#BEEDFF] hover:border-[#016FB4] hover:text-[#016FB4]"
                                        onClick={() => { setSubPagine(0) }}
                                    >
                                        ATRÁS
                                    </button>
                                </div>
            ...
            <Modal open={CrearExamen} footer={null} onCancel={() => { setCrearExamen(false); setEditarExamen(false) }} width="45vw" height="40vw" style={{ display: 'flex' }}>
                ...
                <div className="flex justify-between items-center w-full">
                    ...
                    {/* Botón "EDITAR/CREAR EXAMEN" alineado a la derecha */}
