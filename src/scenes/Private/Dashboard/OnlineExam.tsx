...
export const OnlineExam: React.FC = () => {
    ...
    return (
        <div className="w-full h-full flex flex-col items-center justify-start gap-5 pt-[1vw] p-[1vw] bg-pink-500">
            <div className="flex flex-col justify-center h-full w-full p-[1vw] bg-[yellow]">
                <h1 className="underline pt-1">MIS EXAMENES</h1>
                <div className="bg-white p-4 rounded-lg shadow-md h-[60%] w-full gap-3 border-2 border-solid border-[#F3F3F3]">
                    {/* Header */}
